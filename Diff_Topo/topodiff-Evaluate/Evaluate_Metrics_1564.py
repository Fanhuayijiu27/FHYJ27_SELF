...
def main():
    npz_path = r'D:\Diff_Topo\开源\topodiff-main\Generate_results\eval_1764_test_32channel\generated_flow_channels.npz'
    ...
    gt_files = sorted(glob.glob(os.path.join(test_data_dir, "*.npy")))
    gt_structures = []
    gt_conditions = []
    ...
    for i in range(len(gen_images)):
        ...
        # Data loader guarantees generated samples match sorted GT files exactly.
        gt_struct = gt_structures[i]
