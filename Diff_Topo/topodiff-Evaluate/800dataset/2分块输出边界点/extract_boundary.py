...
# Configuration
input_dir = r'd:\Diff_Topo\开源\topodiff-Evaluate\1三列数据二值化\comsol_topology_XXX'
output_base_dir = r'd:\Diff_Topo\开源\topodiff-Evaluate\2分块输出边界点'
...
print(f"\n===== All 100 samples successfully processed and split into {output_base_dir} =====")
