...
//
//       Filename:  Z:\xinduihuakuang\BossSideMilling.hpp
//
...
#ifndef BOSSSIDEMILLING_H_INCLUDED
#define BOSSSIDEMILLING_H_INCLUDED
...
class DllExport BossSideMilling
{
    // class members
public:
	...
	std::vector<DoubleLayerBoss*> ListOfDLBoss;
	std::vector<NormalBoss*> ListOfNBoss;
	std::vector<NoSideBoss*> ListOfNSBoss;
	bool BossType1;
	bool BossType2;

	BossSideProcessParameter ParameterSet;
	...
	std::vector<NXOpen::Face*> SelectedBossTopFaceList;
	std::vector<NXOpen::Face*> BossTopFaceList;
	std::vector<NXOpen::Face*> SelectedZhiDingFaceList;
    //----------------------- BlockStyler Callback Prototypes ---------------------
    // The following member function prototypes define the callbacks 
    // specified in your BlockStyler dialog.  The empty implementation
    // of these prototypes is provided in the BossSideMilling.cpp file. 
...
private:
    ...
    NXOpen::BlockStyler::Toggle* toggle021;// Block type: Toggle
    NXOpen::BlockStyler::Toggle* toggle0211;// Block type: Toggle
...
#endif //BOSSSIDEMILLING_H_INCLUDED
