#undef CreateDialog
#ifndef DLBossTopMillingCmd_H
#define DLBossTopMillingCmd_H
...
class DLBossTopMillingCmd :
	public TaggedObject
{
public:
	DLBossTopMillingCmd();
	DLBossTopMillingCmd(std::vector<DoubleLayerBoss*> ListOfNBoss, BossTopProcessParameter ParameterSet, Part* WorkPart, Body* WorkBody, Body* WorkBlank, std::vector<Face*>ListOfSelectedFace);
	virtual ~DLBossTopMillingCmd();
