...
public:
    ...
    //---------------------------------------------------------�Զ��庯��--------------------------------------------------------
    int  GetDefaultColor();
    void AutoDetectEndFace();//���޸�
    void GetInfomation();

    //���б���غ���
    void FeatureSpyResultDisplay();
    void GetSelectedIndexAndFeatureName(int &Index, NXString &FeaName);//���б���غ���1
    void ResponseToFeatureList(int iRowIndex, NXString FeatureName);//���б���غ���2
    //���޸�
    ...
    std::vector<NXOpen::Face*>AllFacesVector;//�������е���
    ...
    std::vector<NXString> GrooveClassflyList;//���б�
    std::vector<NXString> BossClassflyList;//͹̨�б�
    std::vector<NXString> HoleClassflyList;//���б�
    ...
    //�������桪�������
    std::vector<NXOpen::Face*>SealFace_DirectionNormalHole;//��ͨͨ��
    std::vector<NXOpen::Face*>SealFace_DirectionRightHole;//��б��ͨ��
    std::vector<NXOpen::Face*>SealFace_DirectionBlindHole;//ä��
    ...
    //��ͱ���������������
    std::vector<NXOpen::Face*>SealFace_WallNormalHole;//����ͨ��
    std::vector<NXOpen::Face*>SealFace_WallCircleCombineHole;//���浹б�Ǹ���ͨ��
    std::vector<NXOpen::Face*>SealFace_RibCombineHole;//���渴�Ͽ�
